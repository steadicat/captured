import {Inline, InlineBlock} from '../stylistic-elements';
...
export const FacebookIcon = component('FacebookIcon', ({$, get, ...props}) => (
  <Icon {...props}>
    <path
...
export const TwitterIcon = component('TwitterIcon', ({$, get, ...props}) => (
  <Icon {...props}>
...
export const EmailIcon = component('EmailIcon', ({$, get, ...props}) => (
  <Icon {...props}>
...
export const SocialLink = hover(
  component(
    'SocialLink',
    ({$, get, href, text, icon: Ico, hovered, ...props}) => (
      <Link
        href={href}
        target="_blank"
        whiteSpace="nowrap"
