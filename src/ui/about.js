...
import {TextLink, List, ListItem, Link} from '../ui/core';
import {HeaderText} from '../ui/header';
import {ResponsiveColumn} from '../ui/layout';
import {Toolbar} from '../ui/toolbar';
import {DefaultFont, Text, BoldText, PageHeading} from '../ui/type';
  ...
  <DefaultFont>
    <Block textAlign="center">
      ...
      <InlineBlock
        ...
        <AboutSection title="Why Bernie?" marginBottom={72}>
          <Text>
        ...
        <ResponsiveColumn fontSize={12} marginTop={24} width="50%">
        ...
        <ResponsiveColumn fontSize={12} marginTop={24} width="50%">
          ...
          <List marginTop={12}>
            <ListItem>Gonzalo Torres</ListItem>
            <ListItem>Jes Pepe</ListItem>
            <ListItem>Meg Worden</ListItem>
            <ListItem>Nick McKinney</ListItem>
            <ListItem>Jeff Kling</ListItem>
          </List>
        </ResponsiveColumn>
      </InlineBlock>
    </Block>
