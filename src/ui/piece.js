...
export const Piece = track(component('Piece', ({get, piece, ...props}) =>
  <Block {...props}>
    ...
    <ResponsiveColumn textAlign="left" width="50%" paddingRight={get('browser.mobile') ? 12 : 48}>
      ...
      <Charges
        ...
        marginBottom={24}
      />
      {get('browser.mobile') && <TextLink display="block" paddingBottom={24} fontWeight="bold" textAlign="left">References</TextLink>}
    </ResponsiveColumn>
    <ResponsiveColumn textAlign="left" width="50%" paddingLeft={get('browser.mobile') ? 12 : 48}>
      ...
      <Charges
        ...
        marginBottom={24}
      />
      {get('browser.mobile') && <TextLink display="block" paddingTop={24} fontWeight="bold" textAlign="left">Contact Info</TextLink>}
    </ResponsiveColumn>
    {!get('browser.mobile') && <Column textAlign="left" width="50%" paddingRight={24}>
      <TextLink
    ...
    {!get('browser.mobile') && <Column textAlign="left" width="50%">
      <TextLink
